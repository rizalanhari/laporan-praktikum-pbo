...
public class Anggota {
    ...
    public Anggota getById(int id) {
        ...
        ResultSet rs = DBHelper1841720218Rizal.selectQuery("SELECT * FROM anggota " + " WHERE idAnggota = '" + id + "'");
    ...
    public ArrayList<Anggota> getAll() {
        ...
        ResultSet rs = DBHelper1841720218Rizal.selectQuery("SELECT * FROM anggota");
    ...
    public void save(){
        if(getById(idAnggota).getIdAnggota() == 0){
            String SQL = "Insert into anggota (nama,alamat,telepon) values(" 
                    ...
                    + " '"+this.telepon+"' "
                    + " )";
                    this.idAnggota = DBHelper1841720218Rizal.insertQueryGetIdRizal(SQL);
        }else{
