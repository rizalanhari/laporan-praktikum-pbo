 ...
 * @author mwpras
 */
public class Peminjaman1841720218Rizal {
    ...
    public Peminjaman1841720218Rizal() {
    }

    public Peminjaman1841720218Rizal(Anggota anggota, Buku buku, String tanggalpinjam, String tanggalkembali) {        
    ...
    public Peminjaman1841720218Rizal getById(int id){
        Peminjaman1841720218Rizal peminjaman = new Peminjaman1841720218Rizal();
        ResultSet rs = DBHelper1841720218Rizal.selectQuery("SELECT "
        ...
        try {
            while(rs.next()){
                peminjaman = new Peminjaman1841720218Rizal();
    ...
    public ArrayList<Peminjaman1841720218Rizal> getAll(){
        ArrayList<Peminjaman1841720218Rizal> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720218Rizal.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
                                        +"      p.tanggalkembali AS tanggalkembali, "
    ...
    public ArrayList<Peminjaman1841720218Rizal> search(String keyword){
        ArrayList<Peminjaman1841720218Rizal> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720218Rizal.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
    ...
    public void save(){
        if(getById(idpeminjaman).getIdpeminjaman()== 0){
            String SQL = "INSERT INTO peminjaman (idanggota, idbuku, tanggalpinjam, tanggalkembali) VALUES("
                    ...
                    +"      '"+ this.tanggalkembali + "' "
                    +"      )";
            this.idpeminjaman = DBHelper1841720218Rizal.insertQueryGetIdRizal(SQL);
